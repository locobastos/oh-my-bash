...
cd "$HOME"
if curl -fsSLN https://github.com/ohmybash/oh-my-bash/archive/master.zip -o oh-my-bash-master.zip && unzip -qq oh-my-bash-master.zip && mv $HOME/oh-my-bash-master $OSH
then
  printf '%s' "$GREEN"
  printf '%s\n' '         __                          __               __  '
